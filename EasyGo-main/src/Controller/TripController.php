...
#[Route('/admin_trip', name: 'app_trip_admin_trip', methods: ['GET', 'POST'])]
public function indexadmin(TripRepository $tripRepository, PaginatorInterface $paginator, Request $request): Response
{
    $searchCriteria = [
        'departurePoint' => $request->query->get('departurePoint'),
        'destination' => $request->query->get('destination'),
